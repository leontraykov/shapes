Spree.admin_slide_locations_search = Spree.pathFor('admin/slide_locations/search');
...
$.fn.slideLocationAutocomplete = function (options) {
  ...
  this.select2({
    ...
    initSelection: function (element, callback) {
      $.get(Spree.admin_slide_locations_search, {
    ...
    ajax: {
      url: Spree.admin_slide_locations_search,
      datatype: 'json',
