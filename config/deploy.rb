...
set :application, "shapes"
set :repo_url, "git@github.com:leontraykov/shapes.git"
set :branch, "main"

# Deploy to the user's home directory
set :deploy_to, "/home/deploy/shapes"
...
server '52.55.9.219', user: 'deploy', roles: %w{app db web}
